...
public interface UserView extends View<ru.training.karaf.model.User> {
   ...
   // Optional<? extends User> getByLogin(String login);
    ...
    Optional<? extends ru.training.karaf.model.User> addRoles(long id, List<Long> rolesIds, String login);
    Optional<? extends ru.training.karaf.model.User> removeRoles(long id, List<Long> rolesIds, String login);
}
